...
Today's blogpost is going to walkthrough the design of RansomGuard - an anti-ransomware filter driver we developed , as well as cover some required internals related to ransomware file-system operations.<br/>
...
Our goal is to be able not only to detect those mapped page writer encryptions , but to pinpoint back at the malicious process behind it.<br/>
