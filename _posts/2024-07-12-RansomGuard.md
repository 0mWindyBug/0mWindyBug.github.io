...
return FLT_PREOP_COMPLETE
```
Whilst it will indeed prevent the write, it can lead to major cache coherncey issues eventually causing applications to fail and potentially the machine to crash.<br/>
